<div class='masjidnow-monthly-container'>
  ...
  <table class='masjidnow-combined-timings'>
    <tr>
      <th></th>
      <th colspan="2"><?php echo($prayer_names["fajr"]) ?></th>
      <th><?php echo($prayer_names["sunrise"]) ?></th>
      <th colspan="2"><?php echo($prayer_names["dhuhr"]) ?></th>
      <th colspan="2"><?php echo($prayer_names["asr"]) ?></th>
      <th colspan="2"><?php echo($prayer_names["maghrib"]) ?></th>
      <th colspan="2"><?php echo($prayer_names["isha"]) ?></th>
    </tr>
    <tr>
